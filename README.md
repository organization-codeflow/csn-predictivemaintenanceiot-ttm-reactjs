...
```bash
git clone https://github.com/organization-codeflow/csn-predictivemaintenanceiot-ttm-reactjs.git
cd csn-predictivemaintenanceiot-ttm-reactjs
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-predictivemaintenanceiot-ttm-reactjs
- Xem các metrics:
